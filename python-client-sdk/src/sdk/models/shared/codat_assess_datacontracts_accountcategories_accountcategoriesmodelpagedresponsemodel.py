...
class CodatAssessDataContractsAccountCategoriesAccountCategoriesModelPagedResponseModel:
    ...
    results: Optional[list[shared_codat_assess_datacontracts_accountcategories_accountcategoriesmodel.CodatAssessDataContractsAccountCategoriesAccountCategoriesModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

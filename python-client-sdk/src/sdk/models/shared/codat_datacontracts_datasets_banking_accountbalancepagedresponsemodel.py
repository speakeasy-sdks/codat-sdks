...
class CodatDataContractsDatasetsBankingAccountBalancePagedResponseModel:
    ...
    links: Optional[shared_codat_datacontracts_datasets_banking_accountbalancepagedresponselinksmodel.CodatDataContractsDatasetsBankingAccountBalancePagedResponseLinksModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[list[shared_codat_datacontracts_datasets_banking_accountbalance.CodatDataContractsDatasetsBankingAccountBalance]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

...
class CodatDataContractsDatasetsCreditNote:
    ...
    line_items: Optional[list[shared_codat_datacontracts_datasets_creditnotelineitem.CodatDataContractsDatasetsCreditNoteLineItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('lineItems'), 'exclude': lambda f: f is None }})

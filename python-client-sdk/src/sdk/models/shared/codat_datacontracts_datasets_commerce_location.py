...
class CodatDataContractsDatasetsCommerceLocation:
    address: Optional[shared_codat_datacontracts_datasets_commerce_address.CodatDataContractsDatasetsCommerceAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address'), 'exclude': lambda f: f is None }})

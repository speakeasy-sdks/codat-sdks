...
class CodatDataContractsDatasetsBankingTransactionCategory:
    ...
    status: Optional[shared_codat_datacontracts_datasets_banking_transactioncategorystatus_enum.CodatDataContractsDatasetsBankingTransactionCategoryStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status'), 'exclude': lambda f: f is None }})

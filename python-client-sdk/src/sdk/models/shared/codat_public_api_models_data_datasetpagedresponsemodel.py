...
class CodatPublicAPIModelsDataDataSetPagedResponseModel:
    ...
    links: Optional[shared_codat_public_api_models_data_datasetpagedresponselinksmodel.CodatPublicAPIModelsDataDataSetPagedResponseLinksModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[list[shared_codat_public_api_models_data_dataset.CodatPublicAPIModelsDataDataSet]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

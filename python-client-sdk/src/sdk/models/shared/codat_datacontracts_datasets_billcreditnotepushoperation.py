...
class CodatDataContractsDatasetsBillCreditNotePushOperation:
    ...
    data: Optional[shared_codat_datacontracts_datasets_billcreditnote.CodatDataContractsDatasetsBillCreditNote] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})

...
class SystemObjectPushOperationPagedResponseModel:
    ...
    links: Optional[shared_system_objectpushoperationpagedresponselinksmodel.SystemObjectPushOperationPagedResponseLinksModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[list[shared_system_objectpushoperation.SystemObjectPushOperation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

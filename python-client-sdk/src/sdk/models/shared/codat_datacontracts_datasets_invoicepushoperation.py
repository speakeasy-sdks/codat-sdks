...
class CodatDataContractsDatasetsInvoicePushOperation:
    ...
    data: Optional[shared_codat_datacontracts_datasets_invoice.CodatDataContractsDatasetsInvoice] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data'), 'exclude': lambda f: f is None }})

...
class CodatDataContractsDatasetsBill:
    ...
    line_items: Optional[list[shared_codat_datacontracts_datasets_billlineitem.CodatDataContractsDatasetsBillLineItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('lineItems'), 'exclude': lambda f: f is None }})
    ...
    purchase_order_refs: Optional[list[shared_codat_datacontracts_datasets_purchaseorderref.CodatDataContractsDatasetsPurchaseOrderRef]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('purchaseOrderRefs'), 'exclude': lambda f: f is None }})

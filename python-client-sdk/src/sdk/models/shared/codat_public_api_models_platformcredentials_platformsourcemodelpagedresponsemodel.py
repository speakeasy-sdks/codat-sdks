...
class CodatPublicAPIModelsPlatformCredentialsPlatformSourceModelPagedResponseModel:
    ...
    results: Optional[list[shared_codat_public_api_models_platformcredentials_platformsourcemodel.CodatPublicAPIModelsPlatformCredentialsPlatformSourceModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

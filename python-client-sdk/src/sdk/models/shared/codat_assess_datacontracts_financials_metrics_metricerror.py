...
class CodatAssessDataContractsFinancialsMetricsMetricError:
    ...
    type: Optional[shared_codat_assess_datacontracts_financials_metrics_metricerrortype_enum.CodatAssessDataContractsFinancialsMetricsMetricErrorTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})

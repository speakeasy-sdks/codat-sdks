...
class CodatDataContractsDatasetsCreditNoteLineItem:
    ...
    tracking: Optional[shared_codat_datacontracts_datasets_accountsreceivabletracking.CodatDataContractsDatasetsAccountsReceivableTracking] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tracking') }})

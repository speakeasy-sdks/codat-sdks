...
from ..shared import codat_datacontracts_datasets_accountsreceivabletracking as shared_codat_datacontracts_datasets_accountsreceivabletracking
...
class CodatDataContractsDatasetsCreditNoteLineItem:
    ...
    tracking: Optional[shared_codat_datacontracts_datasets_accountsreceivabletracking.CodatDataContractsDatasetsAccountsReceivableTracking] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tracking'), 'exclude': lambda f: f is None }})

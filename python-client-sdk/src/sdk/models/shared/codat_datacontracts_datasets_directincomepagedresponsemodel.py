...
class CodatDataContractsDatasetsDirectIncomePagedResponseModel:
    ...
    links: Optional[shared_codat_datacontracts_datasets_directincomepagedresponselinksmodel.CodatDataContractsDatasetsDirectIncomePagedResponseLinksModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[list[shared_codat_datacontracts_datasets_directincome.CodatDataContractsDatasetsDirectIncome]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

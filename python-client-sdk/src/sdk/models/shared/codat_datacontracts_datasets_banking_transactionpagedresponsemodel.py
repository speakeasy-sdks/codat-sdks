...
class CodatDataContractsDatasetsBankingTransactionPagedResponseModel:
    ...
    links: Optional[shared_codat_datacontracts_datasets_banking_transactionpagedresponselinksmodel.CodatDataContractsDatasetsBankingTransactionPagedResponseLinksModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[list[shared_codat_datacontracts_datasets_banking_transaction.CodatDataContractsDatasetsBankingTransaction]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

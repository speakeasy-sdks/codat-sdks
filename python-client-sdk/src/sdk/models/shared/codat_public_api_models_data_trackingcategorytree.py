...
class CodatPublicAPIModelsDataTrackingCategoryTree:
    ...
    sub_categories: Optional[list[CodatPublicAPIModelsDataTrackingCategoryTree]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('subCategories'), 'exclude': lambda f: f is None }})

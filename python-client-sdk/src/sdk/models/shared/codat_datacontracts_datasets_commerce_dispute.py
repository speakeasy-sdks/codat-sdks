...
class CodatDataContractsDatasetsCommerceDispute:
    ...
    disputed_transactions: Optional[list[shared_codat_datacontracts_datasets_commerce_transactionsourceref.CodatDataContractsDatasetsCommerceTransactionSourceRef]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('disputedTransactions'), 'exclude': lambda f: f is None }})
    ...
    status: Optional[shared_codat_datacontracts_datasets_commerce_disputestatus_enum.CodatDataContractsDatasetsCommerceDisputeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status'), 'exclude': lambda f: f is None }})

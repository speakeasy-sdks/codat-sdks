...
class CodatDataContractsDatasetsCommercePaymentMethodPagedResponseModel:
    ...
    links: Optional[shared_codat_datacontracts_datasets_commerce_paymentmethodpagedresponselinksmodel.CodatDataContractsDatasetsCommercePaymentMethodPagedResponseLinksModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[list[shared_codat_datacontracts_datasets_commerce_paymentmethod.CodatDataContractsDatasetsCommercePaymentMethod]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

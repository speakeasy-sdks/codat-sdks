...
class CodatDataContractsDatasetsDirectCostLineItem:
    ...
    tracking: Optional[shared_codat_datacontracts_datasets_invoiceabletracking.CodatDataContractsDatasetsInvoiceableTracking] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tracking'), 'exclude': lambda f: f is None }})

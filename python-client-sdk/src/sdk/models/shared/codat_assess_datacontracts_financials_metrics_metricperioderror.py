...
class CodatAssessDataContractsFinancialsMetricsMetricPeriodError:
    ...
    type: Optional[shared_codat_assess_datacontracts_financials_metrics_metricperioderrortype_enum.CodatAssessDataContractsFinancialsMetricsMetricPeriodErrorTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type'), 'exclude': lambda f: f is None }})

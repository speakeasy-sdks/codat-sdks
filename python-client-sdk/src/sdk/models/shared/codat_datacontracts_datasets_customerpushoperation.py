...
class CodatDataContractsDatasetsCustomerPushOperation:
    ...
    data: Optional[shared_codat_datacontracts_datasets_customer.CodatDataContractsDatasetsCustomer] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data'), 'exclude': lambda f: f is None }})

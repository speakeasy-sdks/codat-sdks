...
class CodatDataContractsDatasetsBillPayment:
    ...
    lines: Optional[list[shared_codat_datacontracts_datasets_billpaymentline.CodatDataContractsDatasetsBillPaymentLine]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('lines'), 'exclude': lambda f: f is None }})

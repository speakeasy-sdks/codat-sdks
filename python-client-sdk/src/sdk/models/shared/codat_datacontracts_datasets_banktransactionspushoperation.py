...
class CodatDataContractsDatasetsBankTransactionsPushOperation:
    ...
    changes: Optional[list[shared_codat_datacontracts_push_pushoperationchange.CodatDataContractsPushPushOperationChange]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('changes'), 'exclude': lambda f: f is None }})
    ...
    data: Optional[shared_codat_datacontracts_datasets_banktransactions.CodatDataContractsDatasetsBankTransactions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data'), 'exclude': lambda f: f is None }})
    ...
    validation: Optional[shared_codat_datacontracts_validation_validationresult.CodatDataContractsValidationValidationResult] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('validation'), 'exclude': lambda f: f is None }})

...
class CodatDataContractsDatasetsBankTransactionsPushOperation:
    ...
    data: Optional[shared_codat_datacontracts_datasets_banktransactions.CodatDataContractsDatasetsBankTransactions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})

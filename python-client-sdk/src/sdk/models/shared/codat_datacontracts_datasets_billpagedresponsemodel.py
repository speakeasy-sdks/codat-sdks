...
class CodatDataContractsDatasetsBillPagedResponseModel:
    ...
    links: Optional[shared_codat_datacontracts_datasets_billpagedresponselinksmodel.CodatDataContractsDatasetsBillPagedResponseLinksModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links'), 'exclude': lambda f: f is None }})
    ...
    results: Optional[list[shared_codat_datacontracts_datasets_bill.CodatDataContractsDatasetsBill]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})

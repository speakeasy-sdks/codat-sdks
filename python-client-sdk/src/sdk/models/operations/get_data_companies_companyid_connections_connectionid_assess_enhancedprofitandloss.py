...
@dataclasses.dataclass
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessEnhancedProfitAndLossSecurity:
...
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessEnhancedProfitAndLossRequest:
    ...
    security: GetDataCompaniesCompanyIDConnectionsConnectionIDAssessEnhancedProfitAndLossSecurity = dataclasses.field()

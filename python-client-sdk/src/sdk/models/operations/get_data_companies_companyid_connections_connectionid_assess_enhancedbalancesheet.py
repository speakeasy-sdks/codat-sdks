...
@dataclasses.dataclass
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessEnhancedBalanceSheetSecurity:
...
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessEnhancedBalanceSheetRequest:
    ...
    security: GetDataCompaniesCompanyIDConnectionsConnectionIDAssessEnhancedBalanceSheetSecurity = dataclasses.field()

...
@dataclasses.dataclass
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessCommerceMetricsOrdersSecurity:
...
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessCommerceMetricsOrdersRequest:
    ...
    security: GetDataCompaniesCompanyIDConnectionsConnectionIDAssessCommerceMetricsOrdersSecurity = dataclasses.field()

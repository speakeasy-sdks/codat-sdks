...
class PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDPathParams:
...
@dataclasses.dataclass
class PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDQueryParams:
...
@dataclasses.dataclass
class PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDSecurity:
    api_key_auth: Optional[shared_security.SchemeAPIKeyAuth] = dataclasses.field(default=None, metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    codat_login: Optional[shared_security.SchemeCodatLogin] = dataclasses.field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDRequest:
    path_params: PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDPathParams = dataclasses.field()
    query_params: PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDQueryParams = dataclasses.field()
    security: PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDSecurity = dataclasses.field()
...
@dataclasses.dataclass
class PutCompaniesCompanyIDConnectionsConnectionIDPushCreditNotesCreditNoteIDResponse:

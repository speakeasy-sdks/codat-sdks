...
@dataclasses.dataclass
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessCommerceMetricsRevenueSecurity:
...
class GetDataCompaniesCompanyIDConnectionsConnectionIDAssessCommerceMetricsRevenueRequest:
    ...
    security: GetDataCompaniesCompanyIDConnectionsConnectionIDAssessCommerceMetricsRevenueSecurity = dataclasses.field()
